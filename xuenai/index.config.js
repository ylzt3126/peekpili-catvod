...
var index_config_base_default = {
  ...
  danmu: {
    urls: [
           ...
           { address: "https://313236.xyz/87654321", name: "默认2" }
          ],
    autoPush: true
  },
  //排序
  order: ["baidu", "tyi", "uc", "quark", "yd", "pan123", "ali", "y115"],
  //网盘
  uc: {
    enable: true,
    prefix: "UC",
  ...
  //tg
  panso: {
    url: "https://so.252035.xyz,https://so.566987.xyz,https://pan.wnng.cn",
    channels: "",
    filter: {
      include: [],
      exclude: ["预告", "枪版", "花絮"]
  ...
  tgsou: {
    ...
    count: 1,
    pic: false,
    channelUsername: "wydwpzy,zyywpzy,sgkwpzy,yunpanuc,ucquark"
  },
  tgchannel: {
    ...
    pic: true,
    channelUsername: "wydwpzy,zyywpzy,sgkwpzy,yunpanuc,ucquark",
    homeChannelUsername: "wydwpzy,zyywpzy,sgkwpzy,yunpanuc,ucquark"
  },
  //alist
  alist: [
    {
